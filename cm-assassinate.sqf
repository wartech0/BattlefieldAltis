...
nul = [ "ASSASSINATE:", _name, 1.5, 3, "#00ff00", "#ff0000", "center", "center" ] execVM "mymessage.sqf"; 
...
nul = [ _marker, _skill ] execVM "spawnofficer.sqf";
...
tCapturedByBlue setTriggerStatements ["isServer && time > (vMissionStartTime+30) && !alive EnemyOfficer", "vMissionSuccess=true; publicVariable ""vMissionSuccess""; vMissionDone=true; publicVariable ""vMissionDone""", ""];
