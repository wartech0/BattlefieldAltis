...
// Light Fog            (5)             [0,2,5,6]                   [0.40,0,[0.2,0.01,15],1,1]
// Medium fog           (6)             [5,6,7]                     [0.40,0,[0.4,0.005,30],1,1]
// Dense Fog            (7)             [6]                         [0.40,0,[0.6,0.0025,45],1,1]
...
// Check if there is no ParamsArray, and pick random if so, otherwise pick from paramsArray.
      if(isNil('paramsArray')) then {
        ...
        initialWeatherParam = vStartingWeather;
